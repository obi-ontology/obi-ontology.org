...
Before you submit a new term, please search [OntoBee](http://www.ontobee.org/browser/index.php?o=OBI) or [BioPortal](http://bioportal.bioontology.org/ontologies/OBI?p=classes) for the term you want and its synonyms. OBI might already include the term you want under a different name.
...
6. example of usage
7. term editor: your name, and that of any collaborators, as it should appear in OBI
